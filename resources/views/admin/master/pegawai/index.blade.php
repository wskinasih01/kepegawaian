                                ...
                                <tbody>
                                    ...
                                    @foreach ($pegawais as $pgw)
                                        <tr>
                                            ...
                                            <td>{{ $pgw->tempat_lahir_pegawai }},
                                                {{ \Carbon\Carbon::parse($pgw->tanggal_lahir_pegawai)->locale('id')->translatedFormat('j F Y') }}
                                            </td>
                                            <td>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{ route('pegawai.show', $pgw->id) }}"><i
                                                            class="fe fe-edit fe-16"></i>&nbsp;Detail</a>
                                                    <form method="POST" action="{{ route('pegawai.destroy', $pgw->id) }}">
                                                        @csrf
