                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('users.update', $user->id)); ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <?php if(isset($user->profil) && $user->profil): ?>
                                            <img src="<?php echo e(asset('storage/' . $user->profil)); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php if(isset($user->profil)): ?>
                                                <small class="text-muted">Current file:
                                                    <?php echo e(basename($user->profil)); ?></small>
                                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo e(old('name', $user->name)); ?>" name="name"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" value="<?php echo e(old('email', $user->email)); ?>" name="email"
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="form-check">
                                                        ...
                                                        <input <?php echo e($hasRoles->contains($role->id) ? 'checked' : ''); ?>

                                                            type="checkbox" id="role-<?php echo e($role->id); ?>" class="rounded"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kepegawaian-crud-spatie2\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>