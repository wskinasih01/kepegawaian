...
<div class="modal fade" id="data-dokumen-lain-edit-modals-<?php echo e($docs->id); ?>" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route('pegawai.data-dokumen-lain.update', $docs->id ?? '')); ?>"
                    id="update-form" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?>
                    <input type="hidden" name="id" id="id" value="<?php echo e($docs->id ?? ''); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_dokumen" id="jenis_dokumen" class="form-control select2">
                            ...
                            <option value="Sertifikat Orientasi"
                                <?php echo e(old('jenis_dokumen', $docs->jenis_dokumen ?? '') == 'Sertifikat Orientasi' ? 'selected' : ''); ?>>
                                Sertifikat Orientasi</option>
                            <option value="Uraian Tugas"
                                <?php echo e(old('jenis_dokumen', $docs->jenis_dokumen ?? '') == 'Uraian Tugas' ? 'selected' : ''); ?>>
                                Uraian Tugas</option>
                            <option value="Penilaian Kinerja"
                                <?php echo e(old('jenis_dokumen', $docs->jenis_dokumen ?? '') == 'Penilaian Kinerja' ? 'selected' : ''); ?>>
                                Penilaian Kinerja</option>
                            <option value="Medical Check Up"
                                <?php echo e(old('jenis_dokumen', $docs->jenis_dokumen ?? '') == 'Medical Check Up' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <?php if(isset($docs->dokumen)): ?>
                            <small class="text-muted">Current file:
                                <?php echo e(basename($docs->dokumen)); ?></small>
                        <?php endif; ?>
...
<?php /**PATH C:\laragon\www\kepegawaian-crud-spatie2\resources\views/admin/master/pegawai/modals/dokumen_lain_edit_modals.blade.php ENDPATH**/ ?>