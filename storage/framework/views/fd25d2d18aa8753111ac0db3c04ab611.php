...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center">
        <div class="col-12">
            <h3 class="page-title">Edit Data Pendidikan</h3>
                ...
                <div class="col-md-6">
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <strong class="card-title">Edit Data Pendidikan</strong>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="<?php echo e(route('pendidikan.update', $pendidikan->id)); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pendidikan" name="pendidikan"
                                        ...
                                        value="<?php echo e(old('pendidikan', $pendidikan->pendidikan)); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\kepegawaian-crud-spatie2\resources\views\admin\master\pendidikan\edit.blade.php ENDPATH**/ ?>